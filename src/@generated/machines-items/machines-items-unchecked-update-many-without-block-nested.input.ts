...
@InputType()
export class machines_itemsUncheckedUpdateManyWithoutBlockNestedInput {
    ...
    @Field(() => [machines_itemsCreateOrConnectWithoutBlockInput], {nullable:true})
    @Type(() => machines_itemsCreateOrConnectWithoutBlockInput)
    connectOrCreate?: Array<machines_itemsCreateOrConnectWithoutBlockInput>;

    @Field(() => [machines_itemsUpsertWithWhereUniqueWithoutBlockInput], {nullable:true})
    ...
    @Field(() => [machines_itemsUpdateWithWhereUniqueWithoutBlockInput], {nullable:true})
    ...
    @Field(() => [machines_itemsUpdateManyWithWhereWithoutBlockInput], {nullable:true})
