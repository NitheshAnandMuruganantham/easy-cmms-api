...
import { BlockCreateNestedOneWithoutInvoicesInput } from '../block/block-create-nested-one-without-invoices.input';
...
export class InvoicesCreateInput {
    ...
    @Field(() => invoice_itemsCreateNestedManyWithoutInvoiceInput, {nullable:true})
