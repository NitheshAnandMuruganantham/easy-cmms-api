...
import { block_settingsOrderByWithRelationAndSearchRelevanceInput } from '../block-settings/block-settings-order-by-with-relation-and-search-relevance.input';
import { block_settingsWhereUniqueInput } from '../block-settings/block-settings-where-unique.input';
import { Int } from '@nestjs/graphql';
import { Block_settingsScalarFieldEnum } from './block-settings-scalar-field.enum';

@ArgsType()
export class FindFirstblockSettingsOrThrowArgs {

    @Field(() => block_settingsWhereInput, {nullable:true})
    @Type(() => block_settingsWhereInput)
    where?: block_settingsWhereInput;

    @Field(() => [block_settingsOrderByWithRelationAndSearchRelevanceInput], {nullable:true})
