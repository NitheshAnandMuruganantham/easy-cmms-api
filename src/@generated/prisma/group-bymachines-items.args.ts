...
import { machines_itemsOrderByWithAggregationInput } from '../machines-items/machines-items-order-by-with-aggregation.input';
import { Machines_itemsScalarFieldEnum } from '../machines/machines-items-scalar-field.enum';
import { machines_itemsScalarWhereWithAggregatesInput } from '../machines-items/machines-items-scalar-where-with-aggregates.input';
