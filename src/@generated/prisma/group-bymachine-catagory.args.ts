...
import { machine_catagoryOrderByWithAggregationInput } from '../machine-catagory/machine-catagory-order-by-with-aggregation.input';
import { Machine_catagoryScalarFieldEnum } from './machine-catagory-scalar-field.enum';
import { machine_catagoryScalarWhereWithAggregatesInput } from '../machine-catagory/machine-catagory-scalar-where-with-aggregates.input';
...
export class GroupBymachineCatagoryArgs {
    ...
    @Field(() => [machine_catagoryOrderByWithAggregationInput], {nullable:true})
