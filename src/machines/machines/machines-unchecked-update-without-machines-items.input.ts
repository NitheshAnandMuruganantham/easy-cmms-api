...
import { routine_maintanancesUncheckedUpdateManyWithoutMeachineNestedInput } from '../../routine-maintanances/routine-maintanances/routine-maintanances-unchecked-update-many-without-meachine-nested.input';

@InputType()
export class MachinesUncheckedUpdateWithoutMachines_itemsInput {
