...
@InputType()
export class MachinesUncheckedUpdateManyWithoutItemsNestedInput {
  ...
  @Field(() => [MachinesUpsertWithWhereUniqueWithoutItemsInput], {
    nullable: true,
  })
