...
@InputType()
export class MachinesUpdateManyWithoutSectionNestedInput {
  ...
  @Field(() => [MachinesUpsertWithWhereUniqueWithoutSectionInput], {
    nullable: true,
  })
