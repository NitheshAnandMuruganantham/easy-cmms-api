...
@InputType()
export class machines_itemsUpdateManyWithoutItemsNestedInput {
    ...
    @Field(() => [machines_itemsUpsertWithWhereUniqueWithoutItemsInput], {nullable:true})
    ...
    @Field(() => [machines_itemsUpdateWithWhereUniqueWithoutItemsInput], {nullable:true})
    ...
    @Field(() => [machines_itemsUpdateManyWithWhereWithoutItemsInput], {nullable:true})
