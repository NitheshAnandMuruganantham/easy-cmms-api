...
import { Machines_itemsAvgAggregate } from '../../../common-dto/prisma/machines-items-avg-aggregate.output';
import { Machines_itemsSumAggregate } from '../../../common-dto/prisma/machines-items-sum-aggregate.output';
import { Machines_itemsMinAggregate } from '../../../common-dto/prisma/machines-items-min-aggregate.output';
import { Machines_itemsMaxAggregate } from '../../../common-dto/prisma/machines-items-max-aggregate.output';
