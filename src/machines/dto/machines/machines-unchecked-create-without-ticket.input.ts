...
import { MaintenanceUncheckedCreateNestedManyWithoutMachinesInput } from '../../../maintanance/dto/maintenance-unchecked-create-nested-many-without-machines.input';
...
@InputType()
export class MachinesUncheckedCreateWithoutTicketInput {
