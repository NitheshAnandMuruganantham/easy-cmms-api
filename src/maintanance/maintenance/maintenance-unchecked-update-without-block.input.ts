...
import { ReplacementsUncheckedUpdateManyWithoutMaintenanceNestedInput } from '../../replacements/replacements/replacements-unchecked-update-many-without-maintenance-nested.input';
import { ReportsUncheckedUpdateManyWithoutMaintenanceNestedInput } from '../../report/reports/reports-unchecked-update-many-without-maintenance-nested.input';
import { TicketUncheckedUpdateOneWithoutMaintenanceNestedInput } from '../../ticket/ticket/ticket-unchecked-update-one-without-maintenance-nested.input';

@InputType()
export class MaintenanceUncheckedUpdateWithoutBlockInput {
