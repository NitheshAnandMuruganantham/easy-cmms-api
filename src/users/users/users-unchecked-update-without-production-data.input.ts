...
import { MaintenanceUncheckedUpdateManyWithoutAssigneeNestedInput } from '../../maintanance/maintenance/maintenance-unchecked-update-many-without-assignee-nested.input';
import { TicketUncheckedUpdateManyWithoutUserNestedInput } from '../../ticket/ticket/ticket-unchecked-update-many-without-user-nested.input';
import { routine_maintanancesUncheckedUpdateManyWithoutAssigneeNestedInput } from '../../routine-maintanances/routine-maintanances/routine-maintanances-unchecked-update-many-without-assignee-nested.input';
...
export class UsersUncheckedUpdateWithoutProduction_dataInput {
  ...
  @Field(() => MaintenanceUncheckedUpdateManyWithoutAssigneeNestedInput, {
    nullable: true,
  })
