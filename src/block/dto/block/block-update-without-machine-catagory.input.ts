...
import { routine_maintanancesUpdateManyWithoutBlockNestedInput } from '../../../routine-maintanances/dto/routine-maintanances-update-many-without-block-nested.input';
...
@InputType()
export class BlockUpdateWithoutMachine_catagoryInput {
