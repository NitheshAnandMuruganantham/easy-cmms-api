...
import { InvoicesUncheckedCreateNestedManyWithoutBlockInput } from '../../../invoices/dto/invoices/invoices-unchecked-create-nested-many-without-block.input';
...
@InputType()
export class BlockUncheckedCreateWithoutMachine_catagoryInput {
