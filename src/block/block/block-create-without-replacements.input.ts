...
import { invoice_itemsCreateNestedManyWithoutBlockInput } from '../../invoices/invoice-items/invoice-items-create-nested-many-without-block.input';

@InputType()
export class BlockCreateWithoutReplacementsInput {
