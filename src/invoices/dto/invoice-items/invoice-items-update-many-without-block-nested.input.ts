...
@InputType()
export class invoice_itemsUpdateManyWithoutBlockNestedInput {
  ...
  @Field(() => [invoice_itemsUpsertWithWhereUniqueWithoutBlockInput], {
    nullable: true,
  })
