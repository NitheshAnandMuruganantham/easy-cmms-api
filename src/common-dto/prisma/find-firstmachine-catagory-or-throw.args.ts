...
@ArgsType()
export class FindFirstmachineCatagoryOrThrowArgs {
  ...
  @Field(() => [Machine_catagoryScalarFieldEnum], { nullable: true })
  distinct?: Array<keyof typeof Machine_catagoryScalarFieldEnum>;
}
