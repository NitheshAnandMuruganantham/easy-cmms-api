...
@InputType()
export class production_dataUpdateManyWithoutUpdatedByNestedInput {
    ...
    @Field(() => [production_dataUpsertWithWhereUniqueWithoutUpdatedByInput], {nullable:true})
    ...
    @Field(() => [production_dataUpdateWithWhereUniqueWithoutUpdatedByInput], {nullable:true})
    ...
    @Field(() => [production_dataUpdateManyWithWhereWithoutUpdatedByInput], {nullable:true})
