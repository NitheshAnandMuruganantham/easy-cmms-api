...
import { MaintenanceUpdateOneRequiredWithoutReportsNestedInput } from '../../maintanance/dto/maintenance-update-one-required-without-reports-nested.input';
import { BlockUpdateOneRequiredWithoutReportsNestedInput } from '../../block/dto/block/block-update-one-required-without-reports-nested.input';
