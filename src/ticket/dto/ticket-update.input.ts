...
import { UsersUpdateOneRequiredWithoutTicketNestedInput } from '../../users/dto/users-update-one-required-without-ticket-nested.input';
import { HideField } from '@nestjs/graphql';
import { MaintenanceUpdateOneWithoutTicketNestedInput } from '../../maintanance/dto/maintenance-update-one-without-ticket-nested.input';
import { MachinesUpdateOneRequiredWithoutTicketNestedInput } from '../../machines/dto/machines/machines-update-one-required-without-ticket-nested.input';
import { BlockUpdateOneRequiredWithoutTicketNestedInput } from '../../block/dto/block/block-update-one-required-without-ticket-nested.input';
