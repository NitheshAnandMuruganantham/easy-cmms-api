...
import { MaintenanceCreateNestedOneWithoutTicketInput } from '../../maintanance/maintenance/maintenance-create-nested-one-without-ticket.input';
import { MachinesCreateNestedOneWithoutTicketInput } from '../../machines/machines/machines-create-nested-one-without-ticket.input';

@InputType()
export class TicketCreateWithoutBlockInput {
