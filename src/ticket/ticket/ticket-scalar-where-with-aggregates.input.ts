...
import { BigIntNullableWithAggregatesFilter } from '../../common-dto/prisma/big-int-nullable-with-aggregates-filter.input';
import { Enumticket_statusWithAggregatesFilter } from '../../common-dto/prisma/enumticket-status-with-aggregates-filter.input';
