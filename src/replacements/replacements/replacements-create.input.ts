...
import { MaintenanceCreateNestedOneWithoutReplacementsInput } from '../../maintanance/maintenance/maintenance-create-nested-one-without-replacements.input';
import { BlockCreateNestedOneWithoutReplacementsInput } from '../../block/block/block-create-nested-one-without-replacements.input';
