...
import { MaintenanceUpdateOneRequiredWithoutReplacementsNestedInput } from '../../maintanance/maintenance/maintenance-update-one-required-without-replacements-nested.input';
...
@InputType()
export class ReplacementsUpdateWithoutItemsInput {
