...
import { UsersUpdateOneRequiredWithoutRoutine_maintanancesNestedInput } from '../../users/users/users-update-one-required-without-routine-maintanances-nested.input';
import { MachinesUpdateOneRequiredWithoutRoutine_maintanancesNestedInput } from '../../machines/machines/machines-update-one-required-without-routine-maintanances-nested.input';
import { BlockUpdateOneRequiredWithoutRoutine_maintanancesNestedInput } from '../../block/block/block-update-one-required-without-routine-maintanances-nested.input';
